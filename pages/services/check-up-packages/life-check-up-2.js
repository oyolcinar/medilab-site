...
const LifeCheckUpTwo = () => {
  const { data: session, status } = useSession();

  return (
    <div className={styles.layout}>
      <Head>
        <title>Life Check Up #2 | Medilab Estetik</title>
        <meta
          name='description'
      ...
      <div className={styles.product}>
        <h1>Life Check Up 2</h1>
        <p>
          <b>Service Code: </b>LCUP2
        </p>
        <p>
        ...
        {session && <Pricetag price={200} discount={15} />}
      </div>
